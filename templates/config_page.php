...
<a class="button add-new-h2" href="admin.php?page=gf_settings&subview=gf_IDPay" style="margin:8px 9px;"><?php echo $dictionary->label4 ?></a>
                ...
                <form method="post" action="" id="gform_form_settings">
                    ...
                    <?php if (empty($hasPriceFieldInForm)) { ?>
                        <div class="gf_IDPay_invalid_form gfIDPayInvalidProduct"
                             id="gf_IDPay_invalid_product_form"><?php echo $dictionary->label7 ?></div>
                    <?php } else { ?>
                        <table <?php echo $VisibleConfigForm?> class="form-table gforms_form_settings"  id="IDPay_field_group">
                            ...
                            <tr>
                                ...
                                <td>
                                    <hr>
                                    <br><span class="description"><?php echo $dictionary->label9 ?></span>
                                    <br><br>
                            ...
                            <tr>
                                <th><?php echo $dictionary->label16 ?></th>
                                <td>
                                    ...
                                    <span class="description"><?php echo $dictionary->label17 ?></span>
                                </td>
                            </tr>

                            <tr>
                                <th><?php echo $dictionary->label18 ?></th>
                                <td>
                                    ...
                                    <span class="description"><?php echo $dictionary->label19 ?></span>
                                    <p class="description"><?php echo $dictionary->label20 ?></p>
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <input type="submit"  value="<?php echo $dictionary->label21 ?>"
